...
class Processor: 
    ...
    def combine(self, video_file, audio_file, output_file, total):
        ...
        print(desktop)
        subprocess.call("%s -i %s -i %s -shortest %s" % (self.resource_path(FFMPEG_DIR),video_file, audio_file, output_file), shell=True)
        print('here')
    ...
    def resource_path(self,relative_path):
        """Helper function that helps with packaging executables
